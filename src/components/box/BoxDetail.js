            ...
            <section className='container'>
                <div className='row mt-md-5 pt-md-4'>
                    <div className="col-md-6 text-center">
                        ...
                        <img src={box.boxPattern.image} className="img-fluid img-rounded mb-sm-30" alt="" />
                    </div>
                    <div className="col-md-6">
                        <div className="item_info">
                            ...
                            <div className="item_info_counts">
                                <div className="item_info_type"><i className="fa fa-image"></i>total product: {box.boxProducts.length}</div>
                                <div className="item_info_views"><i className="fa fa-eye"></i>price: {box.boxPattern.price}.000 VND</div>
                                <div className="item_info_like"><i className="fa fa-heart"></i>18</div>
                            </div>


                            <div className="author_list_info">
                                <h4>brand: {box.boxProducts.map((e)=>(<p key= {e.product.id}>{e.product.brand}</p>))}</h4>
                            </div>
                            <div>
                                <span
